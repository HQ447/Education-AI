...
exports.enrollCourse =
  exports.checkPurchase =
  exports.sendStripePublishableKey =
...
exports.createCheckoutSession = (0, CatchAsyncError_1.CatchAsyncError)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        ...
        return next(
          new AppError_1.AppError(error.message || "Internal server error", 500)
        );
      }
    })
);
exports.verifyPayment = (0, CatchAsyncError_1.CatchAsyncError)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
...
exports.getAllOrders = (0, CatchAsyncError_1.CatchAsyncError)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
...
exports.sendStripePublishableKey = (0, CatchAsyncError_1.CatchAsyncError)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
...
exports.checkPurchase = (0, CatchAsyncError_1.CatchAsyncError)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a;
      try {
        ...
        const user = yield user_model_1.default
          .findById((_a = req.user) === null || _a === void 0 ? void 0 : _a._id)
          .select("+courses");
        if (!user) {
...
exports.enrollCourse = (0, CatchAsyncError_1.CatchAsyncError)(
  (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a;
      try {
        ...
        if (!userId || !courseId) {
          return next(
            new AppError_1.AppError("Missing user ID or course ID", 400)
          );
        }
        const user = yield user_model_1.default
          .findById(userId)
